		...
		usi_app.load = function () {
			...
			try {
				...
				if (!usi_app.suppress_page) {
					...
					if(usi_date.is_between('2025-09-29T00:00:00-07:00','2025-10-06T20:59:00-07:00') && usi_app.url.full.indexOf('/explore/stock-assets-0825') == -1 && location.pathname != "/" && location.pathname != "/pricing") {
